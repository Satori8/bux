...
$count = mysql_numrows(mysql_query("SELECT `id` FROM `tb_auction` WHERE `status`='0'"));
...
$sql = mysql_query("SELECT * FROM `tb_auction` WHERE `status`='0' ORDER BY `date_end` DESC LIMIT  $start_pos,$perpage");
