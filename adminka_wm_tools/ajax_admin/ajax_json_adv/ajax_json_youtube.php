...
if($option == "PlayPause") {
	$sql = mysql_query("SELECT * FROM `tb_ads_youtube` WHERE `id`='$id'") or die(($ajax_json=="json") ? json_encode_cp1251(array("result" => "ERROR", "message" => iconv("CP1251", "UTF-8", mysql_error()))) : mysql_error());
	if(mysql_num_rows($sql)>0) {
		...
		if($status == 0) {
			...
			if($nolimit > 0) {
				...
				mysql_query("UPDATE `tb_ads_youtube` SET `status`='2' WHERE `id`='$id'") or die(($ajax_json=="json") ? json_encode_cp1251(array("result" => "ERROR", "message" => iconv("CP1251", "UTF-8", mysql_error()))) : mysql_error());
			...
			if($nolimit > 0) {
				...
				mysql_query("UPDATE `tb_ads_youtube` SET `status`='1' WHERE `id`='$id'") or die(($ajax_json=="json") ? json_encode_cp1251(array("result" => "ERROR", "message" => iconv("CP1251", "UTF-8", mysql_error()))) : mysql_error());
			...
			mysql_query("UPDATE `tb_ads_youtube` SET `status`='2', `user_lock`='', `msg_lock`='' WHERE `id`='$id'") or die(($ajax_json=="json") ? json_encode_cp1251(array("result" => "ERROR", "message" => iconv("CP1251", "UTF-8", mysql_error()))) : mysql_error());
	...
	if(mysql_num_rows($sql)>0) {
		...
		if($status==4) {
			...
			mysql_query("UPDATE `tb_ads_youtube` SET `status`='4', `user_lock`='$username', `msg_lock`='$msg_lock' WHERE `id`='$id'") or die(($ajax_json=="json") ? json_encode_cp1251(array("result" => "ERROR", "message" => iconv("CP1251", "UTF-8", mysql_error()))) : mysql_error());
		...
		$message_text.= '<div class="box-modal" id="ModalClaimsSurf" style="text-align:justify; width:900px;">';
			...
			$message_text.= '<div class="box-modal-content" style="margin:1px; padding:5px 3px; font-size:11px;">';
				...
				$message_text.= '<div id="table-content" style="overflow:auto;">';
					$message_text.= '<table class="tables" style="margin:0 auto; padding:0;">';
					$sql = mysql_query("SELECT * FROM `tb_ads_claims` WHERE `ident`='$id' AND `type`='youtube' ORDER BY `id` DESC");
					if(mysql_num_rows($sql)>0) {
	...
	$sql = mysql_query("SELECT `ident` FROM `tb_ads_claims` WHERE `id`='$id' AND `type`='youtube'") or die(($ajax_json=="json") ? json_encode_cp1251(array("result" => "ERROR", "message" => iconv("CP1251", "UTF-8", mysql_error()))) : mysql_error());
	if(mysql_num_rows($sql)>0) {
		$row = mysql_fetch_assoc($sql);
		$ident = $row["ident"];

		mysql_query("DELETE FROM `tb_ads_claims` WHERE `id`='$id' AND `type`='youtube'") or die(($ajax_json=="json") ? json_encode_cp1251(array("result" => "ERROR", "message" => iconv("CP1251", "UTF-8", mysql_error()))) : mysql_error());
		mysql_query("UPDATE `tb_ads_youtube` SET `claims`=`claims`-'1' WHERE `id`='$ident'") or die(($ajax_json=="json") ? json_encode_cp1251(array("result" => "ERROR", "message" => iconv("CP1251", "UTF-8", mysql_error()))) : mysql_error());

		$count_claims = mysql_query("SELECT `claims` FROM `tb_ads_youtube` WHERE `id`='$ident'");
	...
	if(mysql_num_rows($sql)>0) {
		...
		mysql_query("UPDATE `tb_ads_youtube` SET `claims`='0' WHERE `id`='$id'") or die(($ajax_json=="json") ? json_encode_cp1251(array("result" => "ERROR", "message" => iconv("CP1251", "UTF-8", mysql_error()))) : mysql_error());
		mysql_query("DELETE FROM `tb_ads_claims` WHERE `ident`='$id' AND `type`='youtube'") or die(($ajax_json=="json") ? json_encode_cp1251(array("result" => "ERROR", "message" => iconv("CP1251", "UTF-8", mysql_error()))) : mysql_error());
	...
	$sql_check = mysql_query("SELECT `id` FROM `tb_ads_youtube` WHERE `id`='$id'") or die(($ajax_json=="json") ? json_encode_cp1251(array("result" => "ERROR", "message" => iconv("CP1251", "UTF-8", mysql_error()))) : mysql_error());
	if(mysql_num_rows($sql_check)>0) {
		mysql_query("DELETE FROM `tb_ads_youtube` WHERE `id`='$id'") or die(($ajax_json=="json") ? json_encode_cp1251(array("result" => "ERROR", "message" => iconv("CP1251", "UTF-8", mysql_error()))) : mysql_error());
