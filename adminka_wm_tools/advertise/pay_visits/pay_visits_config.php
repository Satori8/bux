...
echo '<div id="newform" class="form-adv-list ec.c" onKeyPress="CtrlEnter(event);"><form id="form-adv-'.$ads.'" action="" method="POST" onSubmit="FuncAdv(0, \'adv-config\', \''.$ads.'\', $(this).attr(\'id\'), \''.$token_string.'\', \'modal\'); return false;">';
