...
<ul id="nav">
	...
	<ul>
		...
		<li><a href="index.php?op=checkloading">Анализ нагрузки на сайт</a></li>
		...
		<li><a href="index.php?op=min_pay_config">Минимум кликов в серфинге для выплат</a></li>
				...
				<li><a href="index.php?op=knb_config">КНБ</a></li>
				...
				<li><a href="index.php?op=notif_config">Настройка рассылки не активным</a></li>
				<li><a href="index.php?op=250">Настройки рассылки рефералам </a></li>
	    <li><a href="index.php?op=251">Настройки рассылки в юзерам</a></li>	
	...
	<ul>
		...
		<li><a href="index.php?op=users_vac_list">Пользователи в отпуску</a></li>
		<li><a href="index.php?op=users_repeat_purse">Повторные реквизиты</a></li>
		<li><a href="index.php?op=mail_in">Входящая почта пользователей</a></li>
		<li><a href="index.php?op=mail_out">Исходящая почта пользователей</a></li>
	...
	<li><b>Письма</b>
	<ul>
		<li><a href="index.php?op=mails_config">Настройка рекламы</a></li>
		<li><a href="index.php?op=mails_adreq">Заказы рекламы</a></li>
		<li><a href="index.php?op=mails_add">Добавить рекламу</a></li>
		<li><a href="index.php?op=mails_edit">Просмотр рекламы</a></li>
	...
	<ul>
		...
		<li><a href="index.php?op=konkurs_config_click">Конкурс кликеров №1</a></li>
		<li><a href="index.php?op=konkurs_config_click_big">Конкурс кликеров №2</a></li>
		...
		<li><a href="index.php?op=konkurs_config_ed_hit">Конкурс посетителей</a></li>
