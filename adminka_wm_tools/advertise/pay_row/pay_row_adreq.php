...
$perpage = 20;
$sql_p = mysql_query("SELECT `id` FROM `tb_ads_pay_row` WHERE `status`='0'");
...
$sql = mysql_query("SELECT * FROM `tb_ads_pay_row` WHERE `status`='0' ORDER BY `id` DESC LIMIT $start_pos, $perpage");
