...
echo '</tr>';
echo '<tr>';
	echo '<td align="left"><b>Процент прибыли от акций</b>, (серфинг, Серфинг <span style="color: #3F3F3F;">You</span><span style="border-radius: 5px; background-color: #E62117; padding: 2px; color: #FFFFFF;">Tube</span>, письма, тесты, пакет рекламы, оплачиваемые посещения)</td>';
