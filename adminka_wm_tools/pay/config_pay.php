...
<tr><td width="50%">
	...
	<tr><th width="200" align="left">Минимум к выплате:</th><td><input type="text" class="ok12" name="pay_min" style="text-align:right;" value="<? $sql = mysql_query("SELECT `price` FROM `tb_config` WHERE `item`='pay_min' AND `howmany`='1'"); echo mysql_result($sql,0,0); ?>"> руб.</td></tr>
	<tr><th width="200" align="left">Максимум к выплате (для автовыплат):</th><td><input type="text" class="ok12" name="pay_max" style="text-align:right;" value="<? $sql = mysql_query("SELECT `price` FROM `tb_config` WHERE `item`='pay_max' AND `howmany`='1'"); echo mysql_result($sql,0,0); ?>"> руб.</td></tr>
	<tr><th width="200" align="left">Комисия в процентах:</th><td><input type="text" class="ok12" name="pay_comis1" style="text-align:right;" value="<? $sql = mysql_query("SELECT `price` FROM `tb_config` WHERE `item`='pay_comis' AND `howmany`='1'"); echo mysql_result($sql,0,0); ?>"> %</td></tr>
	<tr><th width="200" align="left">Дополнительная комисия:</th><td><input type="text" class="ok12" name="pay_comis2" style="text-align:right;" value="<? $sql = mysql_query("SELECT `price` FROM `tb_config` WHERE `item`='pay_comis' AND `howmany`='2'"); echo mysql_result($sql,0,0); ?>"> руб.</td></tr>
	</table>
</td><td>
	...
	<tr><th width="200" align="left">Минимум к выплате:</th><td><input type="text" class="ok12" name="pay_min_lp" style="text-align:right;" value="<? $sql = mysql_query("SELECT `price` FROM `tb_config` WHERE `item`='pay_min_lp' AND `howmany`='1'"); echo mysql_result($sql,0,0); ?>"> руб.</td></tr>
	<tr><th width="200" align="left">Максимум к выплате (для автовыплат):</th><td><input type="text" class="ok12" name="pay_max_lp" style="text-align:right;" value="<? $sql = mysql_query("SELECT `price` FROM `tb_config` WHERE `item`='pay_max_lp' AND `howmany`='1'"); echo mysql_result($sql,0,0); ?>"> руб.</td></tr>
	<tr><th width="200" align="left">Комисия в процентах:</th><td><input type="text" class="ok12" name="pay_comis1_lp" style="text-align:right;" value="<? $sql = mysql_query("SELECT `price` FROM `tb_config` WHERE `item`='pay_comis_lp' AND `howmany`='1'"); echo mysql_result($sql,0,0); ?>"> %</td></tr>
	<tr><th width="200" align="left">Дополнительная комисия:</th><td><input type="text" class="ok12" name="pay_comis2_lp" style="text-align:right;" value="<? $sql = mysql_query("SELECT `price` FROM `tb_config` WHERE `item`='pay_comis_lp' AND `howmany`='2'"); echo mysql_result($sql,0,0); ?>"> руб.</td></tr>
	</table>
</td></tr>
...
<tr><td width="50%">
	...
	<tr><th width="200" align="left">Минимум к выплате:</th><td><input type="text" class="ok12" name="pay_min_payeer" style="text-align:right;" value="<? $sql = mysql_query("SELECT `price` FROM `tb_config` WHERE `item`='pay_min_payeer' AND `howmany`='1'"); echo mysql_result($sql,0,0); ?>"> руб.</td></tr>
	<tr><th width="200" align="left">Максимум к выплате (для автовыплат):</th><td><input type="text" class="ok12" name="pay_max_payeer" style="text-align:right;" value="<? $sql = mysql_query("SELECT `price` FROM `tb_config` WHERE `item`='pay_max_payeer' AND `howmany`='1'"); echo mysql_result($sql,0,0); ?>"> руб.</td></tr>
	<tr><th width="200" align="left">Комисия в процентах:</th><td><input type="text" class="ok12" name="pay_comis_payeer" style="text-align:right;" value="<? $sql = mysql_query("SELECT `price` FROM `tb_config` WHERE `item`='pay_comis_payeer' AND `howmany`='1'"); echo mysql_result($sql,0,0); ?>"> %</td></tr>
	</table>
</td><td>
	...
	<tr><th width="200" align="left">Минимум к выплате:</th><td><input type="text" class="ok12" name="pay_min_qw" style="text-align:right;" value="<? $sql = mysql_query("SELECT `price` FROM `tb_config` WHERE `item`='pay_min_qw' AND `howmany`='1'"); echo mysql_result($sql,0,0); ?>"> руб.</td></tr>
	<tr><th width="200" align="left">Максимум к выплате (для автовыплат):</th><td><input type="text" class="ok12" name="pay_max_qw" style="text-align:right;" value="<? $sql = mysql_query("SELECT `price` FROM `tb_config` WHERE `item`='pay_max_qw' AND `howmany`='1'"); echo mysql_result($sql,0,0); ?>"> руб.</td></tr>
	<tr><th width="200" align="left">Комисия в процентах:</th><td><input type="text" class="ok12" name="pay_comis_qw" style="text-align:right;" value="<? $sql = mysql_query("SELECT `price` FROM `tb_config` WHERE `item`='pay_comis_qw' AND `howmany`='1'"); echo mysql_result($sql,0,0); ?>"> %</td></tr>
	</table>
</td></tr>
<tr><td width="50%">
	...
	<tr><th width="200" align="left">Минимум к выплате:</th><td><input type="text" class="ok12" name="pay_min_ym" style="text-align:right;" value="<? $sql = mysql_query("SELECT `price` FROM `tb_config` WHERE `item`='pay_min_ym' AND `howmany`='1'"); echo mysql_result($sql,0,0); ?>"> руб.</td></tr>
	<tr><th width="200" align="left">Максимум к выплате (для автовыплат):</th><td><input type="text" class="ok12" name="pay_max_ym" style="text-align:right;" value="<? $sql = mysql_query("SELECT `price` FROM `tb_config` WHERE `item`='pay_max_ym' AND `howmany`='1'"); echo mysql_result($sql,0,0); ?>"> руб.</td></tr>
	<tr><th width="200" align="left">Комисия в процентах:</th><td><input type="text" class="ok12" name="pay_comis_ym" style="text-align:right;" value="<? $sql = mysql_query("SELECT `price` FROM `tb_config` WHERE `item`='pay_comis_ym' AND `howmany`='1'"); echo mysql_result($sql,0,0); ?>"> %</td></tr>
	</table>
</td><td>
	...
	<tr><th width="200" align="left">Минимум к выплате:</th><td><input type="text" class="ok12" name="pay_min_pm" style="text-align:right;" value="<? $sql = mysql_query("SELECT `price` FROM `tb_config` WHERE `item`='pay_min_pm' AND `howmany`='1'"); echo mysql_result($sql,0,0); ?>"> руб.</td></tr>
	<tr><th width="200" align="left">Максимум к выплате (для автовыплат):</th><td><input type="text" class="ok12" name="pay_max_pm" style="text-align:right;" value="<? $sql = mysql_query("SELECT `price` FROM `tb_config` WHERE `item`='pay_max_pm' AND `howmany`='1'"); echo mysql_result($sql,0,0); ?>"> руб.</td></tr>
	<tr><th width="200" align="left">Комисия в процентах:</th><td><input type="text" class="ok12" name="pay_comis_pm" style="text-align:right;" value="<? $sql = mysql_query("SELECT `price` FROM `tb_config` WHERE `item`='pay_comis_pm' AND `howmany`='1'"); echo mysql_result($sql,0,0); ?>"> %</td></tr>
	</table>
</td></tr>
</table>
<table width="100%">
