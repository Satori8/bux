...
function ScrollTo(){
	$("html, body").animate({scrollTop: $("#GoTop").offset().top-5}, 700);
}
...
if(mysql_num_rows($sql)>0) {
		...
		echo '<tr>';
			echo '<td align="left" colspan="2">';
				...
				echo '<div style="display: block; clear:both; padding-top:4px">';
					echo '<textarea id="description" class="ok" style="height:120px; width:99%;" onKeyup="descchange(\'1\', this, \'2000\');" onKeydown="descchange(\'1\', this, \'2000\');" onClick="descchange(\'1\', this, \'2000\');">'.$row["description"].'</textarea>';
				echo '</div>';
			echo '</td>';
	...
	echo '<div align="center"><span id="Save" onClick="SaveAds('.$id.', \'save\', \'tests\');" class="<span class="proc-btn" onClick="document.location.href=\'/" style="float:none; width:160px;">Сохранить</span></div>';
