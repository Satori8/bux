...
if(isset($_GET["option"]) && limpiar($_GET["option"])=="edit") {
	...
	echo '</table>';
		...
		//echo '<td align="left">Если указать будет отображатся на стене и в коменнатариях к новостям!</td>';
	echo '</tr>';
				echo '<tr>';
	...
	echo '</tr>';
			...
			echo '<td width="50%" valign="top" style="margin:0 auto; padding:0 0 0 2px; border:none; background:none;">';
				...
				echo '<tr><td>Баннерный VIP-серф:</td><td><input type="text" class="ok12" name="ban_serf" value="'.$row["ban_serf"].'"></td></tr>';
				...
				echo '<tr><td>резместился на доске почета:</td><td><input type="text" class="ok12" name="kon_board_m" value="'.$row["kon_board_m"].'"></td></tr>';
