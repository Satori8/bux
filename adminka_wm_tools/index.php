...
<head>
	...
	<link rel="stylesheet" type="text/css" href="css/estilo.css?v=1.06" />
	<link rel="stylesheet" type="text/css" href="css/sdmenu/sdmenu.css?v=1.03" />
	<link rel="stylesheet" type="text/css" href="css/modalpopup.css?v=1.04" />
	<script src="/js/jquery/jquery-3.3.1.min.js"></script>
	<script src="/js/socket.io/socket.io-2.1.1.js"></script>
	<script src="/js/js_modalpopup-0.3.min.js"></script>
	<script src="js/js_upload_av.js?v=2.00"></script>
	<script src="/js/jquery.simpletip-1.3.1.pack.js"></script>
	<script src="js/js_adminka.js?v=1.04"></script>
	<script src="js/js_advs.js?v=1.04"></script>	
	<script src="js/js_main.js?v=1.04"></script>
...
<body>
	...
	<div id="maincontent"><div class="innertube">
		...
		<?php
		$op = (isset($_GET["op"])) ? limpiar(trim($_GET["op"])) : false;
		...
		switch($op) {
			...
			case("min_pay_config"): include('config_site/min_pay_config.php'); break;
			...
			case("checkloading"): 	include("users/checkloading.php"); break;
			...
			case(250): include('config_site/config_mails_all_users.php'); break;
    case(251): include('config_site/config_mails_akkaunt_all_users.php'); break;
			...
			case("mails_config"): include("advertise/mails_new/mails_config.php"); break;
			case("mails_adreq"): include("advertise/mails_new/mails_adreq.php"); break;
			case("mails_add"): include("advertise/mails_new/mails_add.php"); break;
			case("mails_edit"): include("advertise/mails_new/mails_edit.php"); break;
			case("mails_claims"): 	include("advertise/mails_new/mails_claims.php"); break;
			
			case("mail_in"): 	include("users/mail_in.php"); break;
			case("mail_out"): 	include("users/mail_out.php"); break;
			case("users_repeat_purse"): include("users/users_repeat_purse.php"); break;
			case("users_vac_list"): include("users/users_vac_list.php"); break;
			...
			case("notif_config"): 		include("other/notif_not_active_users/notif_config.php"); break;
        ...
        $message = '
                <html>
                    ...
                    <body>
                        <p>The script is working fine, site '.$name.'</p>                   
                    </body>
                </html>';
