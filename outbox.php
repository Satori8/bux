...
if(!isset($_SESSION["userLog"]) && !isset($_SESSION["userPas"]))
{
	...
	//echo '<a href="/inbox.php"><b>Входящие сообщения</b></a> | <a href="'.$_SERVER["PHP_SELF"].'" class="block1"><b>Исходящие сообщения</b></a> | <a href="/newmsg.php"><b>Новое сообщение</b></a><br /><br />';

         echo '<div align="center">';
        echo '<a class="filterline" href="/inbox.php">Входящие сообщения</a>'; 
   echo '<a class="filterlineactive" href="/outbox.php">Исходящие сообщения</a>';
				...
				if(mysql_num_rows($sql)>0)
					{
						...
						echo "<b>Кому:</b>&nbsp;$namein<br />";
						echo "<b>Тема:</b>&nbsp;$subject<br />";
						echo "<b>Сообщение:</b>&nbsp;<br />$message<br /><br />";
						echo '<a href="javascript:history.back(1)">&lt;&lt; Вернуться назад</a><br /><br />';
...
<table class="tables">
	...
	<th class="top" colspan="2">Получатель</th>
...
if(mysql_num_rows($sql)>0)
  ...
  $notif_avatar = GetAvatar($namein, ($namein=="Система" ? 1 : false));
  $_adm_online = mysql_num_rows(mysql_query("SELECT `id` FROM `tb_online` WHERE `username`='".$namein."'"));
					echo '<td style="text-align:center; width:70px; border-right:none; padding:2px 5px;"><a href="/wall?uid='.$sql_igr_us["id"].'" target="_blank]"><img src="/'.$notif_avatar.'" class="avatar" style="width:50px; height:50px" border="0" alt="avatar" title="Перейти на стену пользователя '.$namein.'"></a></td>';
                           echo ' <td style="text-align:left; border-left:none; padding-left:0px;width: 150px;">';
                            echo '<div class="rw_login" style="text-align:left;"><span style="color:#696969;">Логин:</span> '.$namein.'</div>';
