...
//var socket = io.connect('https://'+domen+':3000', {secure: true, reconnect: true, transports:['websocket']});

var socket = io.connect('wss://'+domen+':9000', {secure: true, reconnect: true, transports:['websocket']});
