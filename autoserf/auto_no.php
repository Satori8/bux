...
<head>
	...
	<meta name="Author" content="spartak-bux.ru">
...
if(isset($_SESSION["userLog"]) && isset($_SESSION["userPas"])) {
	...
	$sql_sum = mysql_query("SELECT sum(`money`) FROM `tb_ads_auto_visits` WHERE `username`='$username' AND `type`='visit' AND `date`>'$date_now'") or die(mysql_error());
	$sum_s = mysql_result($sql_sum,0,0);
	@mysql_close();
}
?>
<table border="0" width="100%" height="100%">
<tr><td align="center">На данный момент сайтов<br>для просмотра нет.</td></tr>
<?php
if(isset($_SESSION["userLog"]) && isset($_SESSION["userPas"])) {
echo '<tr><td align="center"><b>Статистика за сегодня ('.DATE("d.m.Y").'):</b><br>Заработано: '.$sum_s.' руб.<br>Просмотрено ссылок: '.$kolvo_s.'</td></tr>';
}
?>
<tr><td align="center" valign="center"><br><b><a href="/advertise.php?ads=auto_serf" target="_blank">Добавить сайт в Авто-серфинг</a></b></td></tr>
</table>
</body>
</html>