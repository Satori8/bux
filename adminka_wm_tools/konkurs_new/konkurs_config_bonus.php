...
if( isset($_POST["type"]) && limpiar($_POST["type"])=="ads" ) {
	...
	if($error==0 && $konk_ads_date_end==$konk_ads_date_start) {
		...
		mysql_query("UPDATE `tb_konkurs_conf` SET `price_array`='$konk_ads_title' WHERE `type`='ads' AND `item`='title'");

		mysql_query("UPDATE `tb_konkurs_conf` SET `price`='$konk_ads_date_start' WHERE `type`='ads' AND `item`='date_start'");
		mysql_query("UPDATE `tb_konkurs_conf` SET `price`='$konk_ads_date_end' WHERE `type`='ads' AND `item`='date_end'");
		mysql_query("UPDATE `tb_konkurs_conf` SET `price`='$konk_ads_min' WHERE `type`='ads' AND `item`='min_do'");
		mysql_query("UPDATE `tb_konkurs_conf` SET `price`='$konk_ads_autostart' WHERE `type`='ads' AND `item`='autostart'");
		mysql_query("UPDATE `tb_konkurs_conf` SET `price`='$konk_ads_all_count_prize' WHERE `type`='ads' AND `item`='all_count_prize'");

		mysql_query("UPDATE `tb_konkurs_conf` SET `price_array`='$konk_ads_count_prize' WHERE `type`='ads' AND `item`='count_prize'");

		mysql_query("UPDATE `tb_konkurs_conf` SET `price_array`='$konk_ads_type_prize' WHERE `type`='ads' AND `item`='type_prize'");

		mysql_query("UPDATE `tb_konkurs_conf` SET `price_array`='$konk_ads_prizes_1' WHERE `type`='ads' AND `item`='prizes' AND `howmany`='1'");
		mysql_query("UPDATE `tb_konkurs_conf` SET `price_array`='$konk_ads_prizes_2' WHERE `type`='ads' AND `item`='prizes' AND `howmany`='2'");
		mysql_query("UPDATE `tb_konkurs_conf` SET `price_array`='$konk_ads_prizes_3' WHERE `type`='ads' AND `item`='prizes' AND `howmany`='3'");
		mysql_query("UPDATE `tb_konkurs_conf` SET `price_array`='$konk_ads_prizes_4' WHERE `type`='ads' AND `item`='prizes' AND `howmany`='4'");
		mysql_query("UPDATE `tb_konkurs_conf` SET `price_array`='$konk_ads_prizes_5' WHERE `type`='ads' AND `item`='prizes' AND `howmany`='5'");
...
$konk_ads_title = mysql_result($sql,0,0);
