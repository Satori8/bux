...
function universal_link_bar($count, $page, $URL, $perpage, $show_link, $page_text='&rp=', $before_page='') {
	...
	if ($page != 1 && $pages_count>=1) {
		...
		if($page==2) {
			$bar_content .= '<td><a href="'.$URL.$before_page.'" style="border: none;"><span class="text14">&larr;</span>&nbsp;Предыдущая</span></a></td><td width="90%">';
		}else{
			$bar_content .= '<td><a href="'.$URL.$before_page.$page_text.($page - 1).'" style="border: none;"><span class="text14">&larr;</span>&nbsp;Предыдущая</span></a></td><td width="90%">';
		}

	}elseif($pages_count>=0) {

		$bar_content .= '<td class="orient"><span class="navygray"><span class="text14">&larr;</span>&nbsp;Предыдущая</span></td><td width="90%">';
	...
	if ($page != $pages_count && $pages_count>=0) {
		$bar_content .= '</td><td><a href="'.$URL.$before_page.$page_text.($page + 1).'" style="border: none;">Следующая&nbsp;<span class="text14">&rarr;</span></a></td>';
	}elseif($pages_count>=0) {
