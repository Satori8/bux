...
if(!isset($_SESSION["userLog"]) && !isset($_SESSION["userPas"])) {
	...
	echo '<span id="adv-title-info" class="adv-title-open" onclick="ShowHideBlock(\'-info\');" style="border-top:solid 1px #46A2FF; text-align:left; padding-left:50px; margin-bottom:2px;">Альтернативные реферальные ссылки - что это?</span>';
	echo '<div id="adv-block-info" style="display:block;padding:5px 7px 10px 7px;text-align:center;background-color: #f1e1ca;font-size: 14px;color: #ab0606;">';
		echo 'Альтернативные реферальные ссылки</br>';
		echo 'предназначены для размещения на ресурсах, где наш проект находится в <b>ЧС</b></br> ';
		echo 'Ссылки будут переодически обновлятся по мере появления в ЧС.</br> ';
		echo 'Первоначальные ссылки так же будут рабочими!';
	echo '</div>';
		...
		echo '<input style="width:468px; text-align:center; margin:5px; padding:5px; display: block;" type="text" value="'.$urll.'?r='.$partnerid.'" onFocus="this.select();"  readonly class="ok" /><br />';
		echo '<b><font color="#000"> Реф ссылка на стр регистрации.</font></b><br />';
		echo '<input style="width:468px; text-align:center; margin:5px; padding:5px; display: block;" type="text" value="'.$urll.'register.php?r='.$partnerid.'" onFocus="this.select();"  readonly class="ok"><br />';
		echo '<b><font color="#000"> Реф ссылка на стр заказа рекламы.</font></b><br />';
		echo '<input style="width:468px; text-align:center; margin:5px; padding:5px; display: block;" type="text" value="'.$urll.'advertise.php?r='.$partnerid.'" onFocus="this.select();" readonly class="ok"><br />';
		echo '<b><font color="#000"> Реф ссылка на стр просмотра ссылок в серфинге.</font></b><br />';
		echo '<input style="width:468px; text-align:center; margin:5px; padding:5px; display: block;" type="text" value="'.$urll.'surfings?r='.$partnerid.'" onFocus="this.select();"  readonly class="ok"><br />';
		echo '<b><font color="#000"> Реф ссылка на стр просмотра видеороликов в серфинге YouTube.</font></b><br />';
		echo '<input style="width:468px; text-align:center; margin:5px; padding:5px; display: block;" type="text" value="'.$urll.'surfingsy?r='.$partnerid.'" onFocus="this.select();"  readonly class="ok" />';
		...
		echo '<div id="LoadBlock-1" style="display: block;">';
			...
			for($i=1; $i>=1; $i--) {
				...
				echo '<div id="BCBlock-1'.$i.'" style="display: none;">';
					echo 'HTML код<br><textarea style="overflow: hidden; height:70px; width:468px;" onFocus="this.select();" readonly class="ok"><a href="'.$urll.'?r='.$partnerid.'" target="_blank"><img src="'.$urll.'img/banners/468x60_'.$i.'.gif" width="468" height="60" border="0"></a></textarea><br>';
					echo 'Ссылка на баннер<br><textarea style="overflow: hidden; height:16px; width:468px;" onFocus="this.select();" readonly class="ok">'.$urll.'img/banners/468x60_'.$i.'.gif</textarea><br><br>';
				echo '</div>';
			}
		echo '</div>';
		...
		echo '<div id="LoadBlock-2" style="display: none;">';
			...
			for($i=1; $i>=1; $i--) {
				...
				echo '<div id="BCBlock-2'.$i.'" style="display: none;">';
					echo 'HTML код<br><textarea style="overflow: hidden; height:70px; width:468px;" onFocus="this.select();" readonly class="ok"><a href="'.$urll.'?r='.$partnerid.'" target="_blank"><img src="'.$urll.'img/banners/200x300_'.$i.'.gif" width="200" height="300" border="0"></a></textarea><br>';
					echo 'Ссылка на баннер<br><textarea style="overflow: hidden; height:16px; width:468px;" onFocus="this.select();" readonly class="ok">'.$urll.'img/banners/200x300_'.$i.'.gif</textarea><br><br>';
				echo '</div>';
			}
		echo '</div>';
		...
		echo '<div id="LoadBlock-3" style="display: none;">';
			...
			for($i=1; $i>=1; $i--) {
				...
				echo '<div id="BCBlock-3'.$i.'" style="display: none;">';
					echo 'HTML код<br><textarea style="overflow: hidden; height:70px; width:468px;" onFocus="this.select();" readonly class="ok"><a href="'.$urll.'?r='.$partnerid.'" target="_blank"><img src="'.$urll.'img/banners/100x100_'.$i.'.gif" width="100" height="100" border="0"></a></textarea><br>';
					echo 'Ссылка на баннер<br><textarea style="overflow: hidden; height:16px; width:468px;" onFocus="this.select();" readonly class="ok">'.$urll.'img/banners/100x100_'.$i.'.gif</textarea><br><br>';
				echo '</div>';
			}
		echo '</div>';
		...
		echo '<div id="LoadBlock-4" style="display: none;">';
			...
			for($i=1; $i>=1; $i--) {
				...
				echo '<div id="BCBlock-4'.$i.'" style="display: none;">';
					echo 'HTML код<br><textarea style="overflow: hidden; height:50px; width:700px;" onFocus="this.select();" readonly class="ok"><a href="'.$urll.'?r='.$partnerid.'" target="_blank"><img src="'.$urll.'img/banners/728x90_'.$i.'.gif" width="728" height="90" border="0"></a></textarea><br>';
					echo 'Ссылка на баннер<br><textarea style="overflow: hidden; height:16px; width:700px;" onFocus="this.select();" readonly class="ok">'.$urll.'img/banners/728x90_'.$i.'.gif</textarea><br><br>';
				echo '</div>';
			}
		echo '</div>';
		...
		echo '<div id="LoadBlock-5" style="display: none;">';
			...
			for($i=1; $i>=1; $i--) {
				...
				echo '<div id="BCBlock-5'.$i.'" style="display: none;">';
					echo 'HTML код<br><textarea style="overflow: hidden; height:50px; width:468px;" onFocus="this.select();" readonly class="ok"><a href="'.$urll.'?r='.$partnerid.'" target="_blank"><img src="'.$urll.'img/banners/88x31_'.$i.'.gif" width="88" height="31" border="0"></a></textarea><br>';
					echo 'Ссылка на баннер<br><textarea style="overflow: hidden; height:16px; width:468px;" onFocus="this.select();" readonly class="ok">'.$urll.'img/banners/88x31_'.$i.'.gif</textarea><br><br>';
				echo '</div>';
			}
		echo '</div>';
