...
<table>
	<tr><th width="200">Цена за 1 неделю:</th><td><input type="text" class="ok12" name="autoref" style="text-align:right;" value="<?php $sql = mysql_query("SELECT price FROM tb_config WHERE item='autoref' and howmany='1'"); echo mysql_result($sql,0,0);?>"> руб.</td></tr>
