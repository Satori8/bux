<?php
if(!DEFINED("FRMLINK_EDIT")) {die ("Hacking attempt!");}

	echo '<a name="goto"></a>';
	echo '<h5 class="sp" style="margin-top:0px; font-size:14px; font-weight:bold; text-align:center;">Редактирование ссылки во фрейме № '.$id.'</h5>';
	...
	if(mysql_num_rows($sql)>0) {
		...
		echo '<tbody>';
			...
			echo '<tr>';
				...
				echo '<td><span style="color:#228B22;"><b>'.number_format($cena_frm_links, 2, ".", " ").'</b> руб./сутки</span></td>';
			echo '</tr>';
		echo '</tbody>';
		echo '</table>';
		echo '</div><br>';
		...
		echo '<div align="center"><span onClick="save_ads('.$row["id"].', \'frmlink\');" class="proc-btn" style="float:none; width:160px;">Сохранить</span></div>';
