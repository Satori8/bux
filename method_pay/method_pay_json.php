...
if($method_pay==1) {
	$message_text.= '<form id="newform" method="POST" action="https://merchant.webmoney.ru/lmi/payment.asp">';
		...
		$message_text.= '<input type="submit" value="Оплатить" class="proc-btn" style="float:none;">';
	$message_text.= '</form>';
	...
	$message_text.= '<form id="newform" method="POST" action="https://sci.interkassa.com/" enctype="utf-8">';
		...
		$message_text.= '<input type="submit" name="process" value="Оплатить" class="proc-btn" style="float:none;">';
	$message_text.= '</form>';
	...
	$message_text.= '<form id="newform" method="POST" action="https://payeer.com/api/merchant/m.php">';
		...
		$message_text.= '<input type="submit" name="m_process" value="Оплатить" class="proc-btn" style="float:none;">';
	$message_text.= '</form>';
	...
	$message_text.= '<form id="newform" method="POST" action="https://megakassa.ru/merchant/">';
		$message_text.= '<input type="hidden" name="shop_id" value="'.$mk_shop_id.'">';
		$message_text.= '<input type="hidden" name="amount" value="'.floatval($money_add).'">';
		$message_text.= '<input type="hidden" name="currency" value="'.$mk_currency.'">';
		...
		$message_text.= '<input type="submit" class="proc-btn" value="Оплатить" style="float:none;">';
	$message_text.= '</form>';
	...
	$message_text.= '<form id="newform" method="GET" accept-charset="windows-1251" action="http://www.free-kassa.ru/merchant/cash.php">';
		...
		$message_text.= '<input type="submit" name="pay" 	value="Оплатить" class="proc-btn" style="float:none;">';
	$message_text.= '</form>';
