...
if( isset($_POST["type"]) && limpiar($_POST["type"])=="hit" ) {
	...
	if($error==0 && $konk_hit_date_end==$konk_hit_date_start) {
		...
		mysql_query("UPDATE `tb_konkurs_conf` SET `price_array`='$konk_hit_title' WHERE `type`='hit' AND `item`='title'");

		mysql_query("UPDATE `tb_konkurs_conf` SET `price`='$konk_hit_date_start' WHERE `type`='hit' AND `item`='date_start'");
		mysql_query("UPDATE `tb_konkurs_conf` SET `price`='$konk_hit_date_end' WHERE `type`='hit' AND `item`='date_end'");
		mysql_query("UPDATE `tb_konkurs_conf` SET `price`='$konk_hit_min' WHERE `type`='hit' AND `item`='min_do'");
		mysql_query("UPDATE `tb_konkurs_conf` SET `price`='$konk_hit_autostart' WHERE `type`='hit' AND `item`='autostart'");
		mysql_query("UPDATE `tb_konkurs_conf` SET `price`='$konk_hit_all_count_prize' WHERE `type`='hit' AND `item`='all_count_prize'");

		mysql_query("UPDATE `tb_konkurs_conf` SET `price_array`='$konk_hit_count_prize' WHERE `type`='hit' AND `item`='count_prize'");

		mysql_query("UPDATE `tb_konkurs_conf` SET `price_array`='$konk_hit_type_prize' WHERE `type`='hit' AND `item`='type_prize'");

		mysql_query("UPDATE `tb_konkurs_conf` SET `price_array`='$konk_hit_prizes_1' WHERE `type`='hit' AND `item`='prizes' AND `howmany`='1'");
		mysql_query("UPDATE `tb_konkurs_conf` SET `price_array`='$konk_hit_prizes_2' WHERE `type`='hit' AND `item`='prizes' AND `howmany`='2'");
		mysql_query("UPDATE `tb_konkurs_conf` SET `price_array`='$konk_hit_prizes_3' WHERE `type`='hit' AND `item`='prizes' AND `howmany`='3'");
		mysql_query("UPDATE `tb_konkurs_conf` SET `price_array`='$konk_hit_prizes_4' WHERE `type`='hit' AND `item`='prizes' AND `howmany`='4'");
		mysql_query("UPDATE `tb_konkurs_conf` SET `price_array`='$konk_hit_prizes_5' WHERE `type`='hit' AND `item`='prizes' AND `howmany`='5'");
