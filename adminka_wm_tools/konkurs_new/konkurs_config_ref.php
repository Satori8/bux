...
*/
	if($error==0 && $konk_ref_date_end==$konk_ref_date_start) {
		...
		mysql_query("UPDATE `tb_konkurs_conf` SET `price`='$konk_ref_date_start' WHERE `type`='ref' AND `item`='date_start'");
		mysql_query("UPDATE `tb_konkurs_conf` SET `price`='$konk_ref_date_end' WHERE `type`='ref' AND `item`='date_end'");
		mysql_query("UPDATE `tb_konkurs_conf` SET `price`='$konk_ref_min' WHERE `type`='ref' AND `item`='min_ref'");
		mysql_query("UPDATE `tb_konkurs_conf` SET `price`='$konk_ref_min_click' WHERE `type`='ref' AND `item`='min_click'");
		mysql_query("UPDATE `tb_konkurs_conf` SET `price`='$konk_ref_min_day_act' WHERE `type`='ref' AND `item`='min_day_act'");

		mysql_query("UPDATE `tb_konkurs_conf` SET `price`='$konk_ref_autostart' WHERE `type`='ref' AND `item`='autostart'");
		mysql_query("UPDATE `tb_konkurs_conf` SET `price`='$konk_ref_all_count_prize' WHERE `type`='ref' AND `item`='all_count_prize'");

		mysql_query("UPDATE `tb_konkurs_conf` SET `price_array`='$konk_ref_count_prize' WHERE `type`='ref' AND `item`='count_prize'");

		mysql_query("UPDATE `tb_konkurs_conf` SET `price_array`='$konk_ref_type_prize' WHERE `type`='ref' AND `item`='type_prize'");

		mysql_query("UPDATE `tb_konkurs_conf` SET `price_array`='$konk_ref_prizes_1' WHERE `type`='ref' AND `item`='prizes' AND `howmany`='1'");
		mysql_query("UPDATE `tb_konkurs_conf` SET `price_array`='$konk_ref_prizes_2' WHERE `type`='ref' AND `item`='prizes' AND `howmany`='2'");
		mysql_query("UPDATE `tb_konkurs_conf` SET `price_array`='$konk_ref_prizes_3' WHERE `type`='ref' AND `item`='prizes' AND `howmany`='3'");
