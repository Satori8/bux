...
$pagetitle = "Список рефералов 2ур.";
include('header.php');
...
if(!isset($_SESSION["userLog"]) && !isset($_SESSION["userPas"])) {
	...
	$count = mysql_numrows(mysql_query("SELECT `id` FROM `tb_users` WHERE $WHERE `referer2`='$username'"));
	...
	echo '</tr>';
	echo '<tr align="center">';
		echo '<td class="adv"><a href="/referals1.php" class="menuheader">1-го уровня</a><span class="adv-statistics" style="margin-top:1px;" title="Статистика заработка рефералами I уровня" onClick="FuncStatRef(\'StatRefCashL1\', \''.$token_stat_ref1.'\', \'Статистика заработка рефералами I уровня\')"></span></td>';
		echo '<td class="adv"><a href="/referals2.php" class="menuheader">2-го уровня</a><span class="adv-statistics" style="margin-top:1px;" title="Статистика заработка рефералами II уровня" onClick="FuncStatRef(\'StatRefCashL2\', \''.$token_stat_ref2.'\', \'Статистика заработка рефералами II уровня\')"></span></td>';
		echo '<td class="adv"><a href="/referals3.php" class="menuheader">3-го уровня</a><span class="adv-statistics" style="margin-top:1px;" title="Статистика заработка рефералами III уровня" onClick="FuncStatRef(\'StatRefCashL3\', \''.$token_stat_ref3.'\', \'Статистика заработка рефералами III уровня\')"></span></td>';
		//echo '<td class="adv"><a href="/referals4.php" class="menuheader">4-го уровня</a><span class="adv-statistics" style="margin-top:1px;" title="Статистика заработка рефералами IV уровня" onClick="FuncStatRef(\'StatRefCashL4\', \''.$token_stat_ref4.'\', \'Статистика заработка рефералами IV уровня\')"></span></td>';
		//echo '<td class="adv"><a href="/referals5.php" class="menuheader">5-го уровня</a><span class="adv-statistics" style="margin-top:1px;" title="Статистика заработка рефералами V уровня" onClick="FuncStatRef(\'StatRefCashL5\', \''.$token_stat_ref5.'\', \'Статистика заработка рефералами V уровня\')"></span></td>';
	echo '</tr>';
	echo '</table><br>';
	...
	$sql = mysql_query("SELECT * FROM `tb_users` WHERE $WHERE `referer2`='$username' ORDER BY $s_tab $u_tab LIMIT $start_pos,$perpage");
