...
echo '<tr><td align="center" style="background:#F0F8FF; border:none; padding:10px; color:#E32636; box-shadow:0 1px 2px rgba(0, 0, 0, 0.4);">При удалении тестов (возврате средств) система взымает '.$tests_comis_del.'% от возвращаемой суммы.<br>Суммы менее 1.00 руб. не возвращаются.</td></tr>';
echo '</table><br>';
...
echo '<div align="center"><a class="sub-blue160" href="/advertise.php?ads='.$ads.'" style="width:160px; margin-top:20px; float:none;">Разместить тест</a></div>';
?>