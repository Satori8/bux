...
if(isset($_SERVER["HTTP_X_REQUESTED_WITH"]) && $_SERVER["HTTP_X_REQUESTED_WITH"]=="XMLHttpRequest") {
	...
	if($auth_user["status"] == "FALSE") {
		...
		$sql_ads = mysql_query("SELECT `id` FROM `".$TABLES."` WHERE `id`='$id' AND `status`='pay'") or die(json_encode_cp1251(array("result" => "ERROR", "message" => iconv("CP1251", "UTF-8", mysql_error()))));
