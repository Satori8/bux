...
if(!isset($_SESSION["userLog"]) && !isset($_SESSION["userPas"])) {
	...
	echo '<div id="adv-block-info" style="display:block; padding:5px 7px 10px 7px; text-align:justify; background-color:#FFFFFF;">';
		echo 'Альтернативные реферальные ссылки';
		echo 'преднозначены для размещения на ресурсах где наш проект находится в <b>ЧС</b> ';
		echo 'Ссыслки будут переодически обновлятся по мере появления в ЧС. ';
		echo 'Старые ссылки так же будут рабочими!';
	echo '</div>';
