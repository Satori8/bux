					...
					echo '<td align="center" class="td-serf" colspan="3">';
						echo '<span class="warning-info1" style="margin-bottom:0; font-weight:normal;">';
							...
							if($my_vip_serf<=0 | $my_ban_serf<=0) {
								...
								echo '<div style="margin-top:2px;"><a href="/advertise.php?ads=dlink" target="_blank">&gt;&gt; Перейти к заказу VIP серфинга и активировать доступ &lt;&lt;</a></div>';
							}
						echo '</span>';
					echo '</td>';
				echo '<tr>';
...
if($count_sites==0) {
	echo '<div align="center" style="margin-bottom:15px;">';
		echo '<div style="background: url(img/light.png) no-repeat top center; font-size: 14px; color: #135B11; text-align: center; padding-top: 120px; margin: 20px auto 15px; display: block;">Доступных к просмотру рекламных ссылок нет.<br>Заходите позже</div>';
		echo '<div align="center" onClick="document.location.href=\'/advertise.php?ads=dlink\';" class="sub-blue160">Разместить ссылку</div>';
	echo '</div>';
}
