...
$perpage = 20;
$sql_p = mysql_query("SELECT `id` FROM `tb_ads_articles` WHERE `status`='4'");
...
$sql = mysql_query("SELECT * FROM `tb_ads_articles` WHERE `status`='4' ORDER BY `id` DESC LIMIT $start_pos, $perpage");
