...
echo '<h3 class="sp" style="margin-top:0; padding-top:0;"><b>Ќастройки начислени€ баллов рейтинга</b></h1>';
...
if(count($_POST)>0) {
	...
	echo '<span id="info-msg" class="msg-ok">»зменени€ успешно сохранены!</span>';
...
echo '<tr valign="top"><td width="49.5%" style="margin:0; padding:0; background:none; border:none;">';
	echo '<table class="tables" style="margin:0; padding:0;">';
		echo '<tr align="center"><th>ѕараметр</th><th width="125">«начение</th></tr>';
		...
		echo '<tr align="left"><td><b>за выполнение задани€ рекламодател€</b>:</td><td align="center"><input type="text" class="ok12" name="reit_task" value="'.$reit_task.'" style="text-align:right;"></td></tr>';
...
echo '<td width="49.5%" style="margin:0; padding:0; background:none; border:none;">';
	...
	echo '</table>';
echo '</td></tr>';
echo '<tr align="center"><td colspan="3" style="background:none;"><input type="submit" value="Cохранить изменени€" class="sub-blue160"></td></tr>';
echo '</table>';
echo '</form>';
