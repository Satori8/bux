...
if(isset($_POST["id"])) {
	...
	if($option=="add")	{
		mysql_query("UPDATE `tb_ads_auto` SET `status`='1', `date`='".time()."' WHERE `id`='$id'") or die(mysql_error());
...
$sql = mysql_query("SELECT * FROM `tb_ads_auto` WHERE `status`='0' ORDER BY `id` ASC");
