...
echo '</td><td width="50%" valign="top" style="margin:0 auto; padding:0 0 0 2px; border:none; background:none;">';
	...
	echo '<h3 class="sp" style="margin-top:0; padding-top:0;">Бонусный серфинг</h3>';
	echo '<table class="tables" style="margin:0 auto; padding:0;">';
		echo '<tr align="center"><th>Параметр</th><th width="125">Значение</th></tr>';
		echo '<tr>';
			...
			echo '<td align="right">';
				echo '<select name="bonus_surf_status" class="ok12" style="width:126px; text-align:center;">';
					echo '<option value="0" '.("0" == $bonus_surf_status ? 'selected="selected"' : false).'>Отключена</option>';
					echo '<option value="1" '.("1" == $bonus_surf_status ? 'selected="selected"' : false).'>Активна</option>';
				echo '</select>';
			echo '</td>';
		echo '</tr>';
		echo '<tr align="left">';
			echo '<td><b>За каждые полные потраченные средства на оплату рекламы</b>, (руб.)</td>';
		...
		echo '</tr>';
		echo '<tr align="left">';
			echo '<td><b>Начислять бонусных показов в серфинге</b>, (шт.)</td>';
