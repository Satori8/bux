...
if(count($_POST)>0) {
	...
	for($i=1; $i<=$y; $i++) {
		...
		//$c_4[$i] = intval(trim($_POST["c_4_$i"]));
		//$c_5[$i] = intval(trim($_POST["c_5_$i"]));
		...
		mysql_query("UPDATE `tb_config_rang` SET `r_ot`='$r_ot[$i]', `r_do`='$r_do[$i]', 
		...
		WHERE `id`='$id[$i]'") or die(mysql_error());

	if($i==$y) {
			echo '<span id="info-msg" class="msg-ok">Изменения успешно сохранены!</span>';
			echo '<script type="text/javascript">
				setTimeout(function() {window.history.replaceState(null, null, "'.$_SERVER["PHP_SELF"].'?op='.limpiar($_GET["op"]).'");}, 100);
...
echo '<table class="tables" style="margin-top:0px;">';
	echo '<tr>';
		...
		echo '<th class="center" rowspan="2">Рейтинг<br>кол-во баллов от и до</th>';
	...
	if(mysql_num_rows($sql)>0) {
		while ($row = mysql_fetch_array($sql)) {
			...
			echo '<tr>';
				echo '<td class="center"><b>'.$row["rang"].'</b></td>';
				if($row["id"]==10) {
        			...
        			echo '<td class="center"><input type="text" class="ok12" style="width:30px; text-align:center;" name="c_1_'.$row["id"].'" value="'.$row["c_1"].'"> - <input type="text" class="ok12" style="width:30px; text-align:center;" name="c_2_'.$row["id"].'" value="'.$row["c_2"].'"> - <input type="text" class="ok12" style="width:30px; text-align:center;" name="c_3_'.$row["id"].'" value="'.$row["c_3"].'"></td>';
        			echo '<td class="center"><input type="text" class="ok12" style="width:30px; text-align:center;" name="youtube_1_'.$row["id"].'" value="'.$row["youtube_1"].'"> - <input type="text" class="ok12" style="width:30px; text-align:center;" name="youtube_2_'.$row["id"].'" value="'.$row["youtube_2"].'"> - <input type="text" class="ok12" style="width:30px; text-align:center;" name="youtube_3_'.$row["id"].'" value="'.$row["youtube_3"].'"></td>';
	        		echo '<td class="center"><input type="text" class="ok12" style="width:30px; text-align:center;" name="m_1_'.$row["id"].'" value="'.$row["m_1"].'"> - <input type="text" class="ok12" style="width:30px; text-align:center;" name="m_2_'.$row["id"].'" value="'.$row["m_2"].'"> - <input type="text" class="ok12" style="width:30px; text-align:center;" name="m_3_'.$row["id"].'" value="'.$row["m_3"].'"></td>';
        			echo '<td class="center"><input type="text" class="ok12" style="width:30px; text-align:center;" name="t_1_'.$row["id"].'" value="'.$row["t_1"].'"> - <input type="text" class="ok12" style="width:30px; text-align:center;" name="t_2_'.$row["id"].'" value="'.$row["t_2"].'"> - <input type="text" class="ok12" style="width:30px; text-align:center;" name="t_3_'.$row["id"].'" value="'.$row["t_3"].'"></td>';
        			echo '<td class="center"><input type="text" class="ok12" style="width:30px; text-align:center;" name="test_1_'.$row["id"].'" value="'.$row["test_1"].'"> - <input type="text" class="ok12" style="width:30px; text-align:center;" name="test_2_'.$row["id"].'" value="'.$row["test_2"].'"> - <input type="text" class="ok12" style="width:30px; text-align:center;" name="test_3_'.$row["id"].'" value="'.$row["test_3"].'"></td>';
					echo '<td align="center"><input type="text" class="ok12" style="width:30px; text-align:center;" name="pv_1_'.$row["id"].'" value="'.$row["pv_1"].'"> - <input type="text" class="ok12" style="width:30px; text-align:center;" name="pv_2_'.$row["id"].'" value="'.$row["pv_2"].'"> - <input type="text" class="ok12" style="width:30px; text-align:center;" name="pv_3_'.$row["id"].'" value="'.$row["pv_3"].'"></td>';
        			echo '<td class="center"><input type="text" class="ok12" style="width:25px; text-align:center;" name="balance_1_'.$row["id"].'" value="'.$row["balance_1"].'"></td>';
					echo '<td align="center"><input type="text" class="ok12" style="width:25px; text-align:center;" name="max_pay_'.$row["id"].'" value="'.$row["max_pay"].'"></td>';
					echo '<td align="center"><input type="text" class="ok12" style="width:25px; text-align:center;" name="pay_min_click_'.$row["id"].'" value="'.$row["pay_min_click"].'"></td>';
