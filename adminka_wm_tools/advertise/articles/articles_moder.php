...
$perpage = 20;
$sql_p = mysql_query("SELECT `id` FROM `tb_ads_articles` WHERE `status`='2'");
...
$sql = mysql_query("SELECT * FROM `tb_ads_articles` WHERE `status`='2' ORDER BY `id` DESC LIMIT $start_pos, $perpage");
