...
if( isset($_POST["type"]) && limpiar($_POST["type"])=="ads_big" ) {
	...
	if($error==0 && $konk_ads_big_date_end==$konk_ads_big_date_start) {
		...
		mysql_query("UPDATE `tb_konkurs_conf` SET `price_array`='$konk_ads_big_title' WHERE `type`='ads_big' AND `item`='title'");

		mysql_query("UPDATE `tb_konkurs_conf` SET `price`='$konk_ads_big_date_start' WHERE `type`='ads_big' AND `item`='date_start'");
		mysql_query("UPDATE `tb_konkurs_conf` SET `price`='$konk_ads_big_date_end' WHERE `type`='ads_big' AND `item`='date_end'");
		mysql_query("UPDATE `tb_konkurs_conf` SET `price`='$konk_ads_big_min' WHERE `type`='ads_big' AND `item`='min_do'");
		mysql_query("UPDATE `tb_konkurs_conf` SET `price`='$konk_ads_big_autostart' WHERE `type`='ads_big' AND `item`='autostart'");
		mysql_query("UPDATE `tb_konkurs_conf` SET `price`='$konk_ads_big_all_count_prize' WHERE `type`='ads_big' AND `item`='all_count_prize'");

		mysql_query("UPDATE `tb_konkurs_conf` SET `price_array`='$konk_ads_big_count_prize' WHERE `type`='ads_big' AND `item`='count_prize'");

		mysql_query("UPDATE `tb_konkurs_conf` SET `price_array`='$konk_ads_big_type_prize' WHERE `type`='ads_big' AND `item`='type_prize'");

		mysql_query("UPDATE `tb_konkurs_conf` SET `price_array`='$konk_ads_big_prizes_1' WHERE `type`='ads_big' AND `item`='prizes' AND `howmany`='1'");
		mysql_query("UPDATE `tb_konkurs_conf` SET `price_array`='$konk_ads_big_prizes_2' WHERE `type`='ads_big' AND `item`='prizes' AND `howmany`='2'");
		mysql_query("UPDATE `tb_konkurs_conf` SET `price_array`='$konk_ads_big_prizes_3' WHERE `type`='ads_big' AND `item`='prizes' AND `howmany`='3'");
		mysql_query("UPDATE `tb_konkurs_conf` SET `price_array`='$konk_ads_big_prizes_4' WHERE `type`='ads_big' AND `item`='prizes' AND `howmany`='4'");
		mysql_query("UPDATE `tb_konkurs_conf` SET `price_array`='$konk_ads_big_prizes_5' WHERE `type`='ads_big' AND `item`='prizes' AND `howmany`='5'");
...
$konk_ads_big_title = mysql_result($sql,0,0);
