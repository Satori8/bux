...
if( isset($_POST["type"]) && limpiar($_POST["type"])=="serf" ) {
	...
	for($y=1; $y<=3; $y++) {
		for($i=1; $i<=10; $i++) {
			...
			}elseif($i>1 && $i<10 && ($konk_serf_prizes[1][$i]==0 && $konk_serf_prizes[2][$i]==0 && $konk_serf_prizes[5][$i]==0) && ($konk_serf_prizes[1][$i+1]>0 | $konk_serf_prizes[2][$i+1]>0 | $konk_serf_prizes[3][$i+1]>0)) {
				$error++;
	...
	if($error==0 && $konk_serf_date_end==$konk_serf_date_start) {
		...
		mysql_query("UPDATE `tb_konkurs_conf` SET `price_array`='$konk_serf_title' WHERE `type`='serf' AND `item`='title'");

		mysql_query("UPDATE `tb_konkurs_conf` SET `price`='$konk_serf_date_start' WHERE `type`='serf' AND `item`='date_start'");
		mysql_query("UPDATE `tb_konkurs_conf` SET `price`='$konk_serf_date_end' WHERE `type`='serf' AND `item`='date_end'");
		mysql_query("UPDATE `tb_konkurs_conf` SET `price`='$konk_serf_min' WHERE `type`='serf' AND `item`='min_do'");
		mysql_query("UPDATE `tb_konkurs_conf` SET `price`='$konk_serf_autostart' WHERE `type`='serf' AND `item`='autostart'");
		mysql_query("UPDATE `tb_konkurs_conf` SET `price`='$konk_serf_all_count_prize' WHERE `type`='serf' AND `item`='all_count_prize'");
        mysql_query("UPDATE `tb_konkurs_conf` SET `price`='$konk_serf_timer' WHERE `type`='serf' AND `item`='timer_ot'");
		mysql_query("UPDATE `tb_konkurs_conf` SET `price_array`='$konk_serf_count_prize' WHERE `type`='serf' AND `item`='count_prize'");

		mysql_query("UPDATE `tb_konkurs_conf` SET `price_array`='$konk_serf_type_prize' WHERE `type`='serf' AND `item`='type_prize'");

		mysql_query("UPDATE `tb_konkurs_conf` SET `price_array`='$konk_serf_prizes_1' WHERE `type`='serf' AND `item`='prizes' AND `howmany`='1'");
		mysql_query("UPDATE `tb_konkurs_conf` SET `price_array`='$konk_serf_prizes_2' WHERE `type`='serf' AND `item`='prizes' AND `howmany`='2'");
		mysql_query("UPDATE `tb_konkurs_conf` SET `price_array`='$konk_serf_prizes_3' WHERE `type`='serf' AND `item`='prizes' AND `howmany`='3'");
...
$konk_serf_title = mysql_result($sql,0,0);
